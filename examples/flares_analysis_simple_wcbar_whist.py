...
x = 'log10Mstar_30'
y = 'log10sSFR'
z = 'log10SFR_inst_30' # used for the colour bar

# --- make plot with colour bar plot
fig, ax, cax, hax = flares_analysis.simple_wcbar_whist(D, x, y, z, s, limits = limits, labels = labels, cmap = cm.viridis)


fig.savefig(f'simple_wcbar_whist.pdf')
