...
# for ii in ${array[@]}
#   do
#     python3 write_req_arrs.py $SLURM_ARRAY_TASK_ID $ii FLARES $output_folder req_arrs_temp.txt
#     # python3 write_particle_derived.py $SLURM_ARRAY_TASK_ID $ii FLARES $output_folder
#     # python3 calc_Zlos.py $SLURM_ARRAY_TASK_ID $ii FLARES $output_folder
# done

### For PERIODIC boxes: REF and AGNdT9
# array=(002_z009p993 003_z008p988 004_z008p075 005_z007p050 006_z005p971 008_z005p037 010_z003p984 011_z003p528 012_z003p017 013_z002p478 015_z002p012 017_z001p487 019_z001p004)
array=(011_z003p528 012_z003p017 013_z002p478 015_z002p012 017_z001p487 019_z001p004)


for ii in ${array[@]}
  do
    python3 write_req_arrs.py 0 $ii REF $output_folder req_arrs.txt
    # python3 write_particle_derived.py 0 $ii REF $output_folder
    # python3 calc_Zlos.py 0 $ii REF $output_folder
done
