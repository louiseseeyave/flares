...
#SBATCH -A dp004
#SBATCH -p cosma7
#SBATCH --job-name=phot_write_FLARES_fl
#SBATCH -t 0-4:00
#SBATCH --array=0-39
#SBATCH --ntasks 1
...
array=(010_z005p000 009_z006p000 008_z007p000 007_z008p000)
...
# array=(010_z003p984 012_z003p017 015_z002p012)
#  
# for ii in ${array[@]}
#    do
#      # python3 download_photproperties.py 00 $ii REF Luminosity data
#      python3 download_photproperties.py 00 $ii REF Flux data
# #     # python3 download_photproperties.py 00 $ii REF SED data
# #     # python3 download_photproperties.py 00 $ii REF Lines data
# done
